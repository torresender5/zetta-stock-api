import { Controller, Get, Post, Patch, Delete, UseGuards, Body, HttpCode, HttpStatus, Inject, Param} from '@nestjs/common';
...
export class ClientsController {
    constructor(private clientService: ClientsService, @Inject(WINSTON_MODULE_PROVIDER) private readonly logger: Logger) {}
